...
if __name__ == '__main__':
    ...
    pos_src = 'automated_evaluation/generated_samples/positive/seed=1,positive,name=BC_VAD,samples=500,itrs=10,vad_t=0.01,changes=6.80,time=35343.50'
    neg_src = 'automated_evaluation/generated_samples/negative/seed=1,negative,name=BC_VAD,samples=500,itrs=10,vad_t=0.01,changes=7.53,time=35909.85'

    seed = 1
    step_size = 0.03
    pos_changes = 6.80
    neg_changes = 7.53
    baseline_name = 'PPLM-Fixed-Threshold'
    ...
    length = 50
    num_iterations = 10
    inference_time_per_word = (35343.50 + 35909.85) / total_samples / length
    # obtain samples
