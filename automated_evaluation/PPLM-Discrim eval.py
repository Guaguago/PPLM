...
if __name__ == '__main__':
    ...
    pos_src = 'automated_evaluation/generated_samples/positive/seed=1,positive,name=BC,samples=500,itrs=3,vad_t=0.01,changes=0.00,time=12531.85'
    neg_src = 'automated_evaluation/generated_samples/positive/seed=1,negative,name=BC,samples=500,itrs=3,vad_t=0.01,changes=0.00,time=12448.12'

    seed = 1
    step_size = 0.03
    baseline_name = 'PPLM-Discrim'
    num_samples_per_prefix = 10
    total_samples = len(prefixes) * num_samples_per_prefix * 2
    length = 50
    num_iterations = 3
    inference_time_per_word = (12531.85 + 12448.12) / total_samples / length
    # obtain samples
