...
if __name__ == '__main__':
    ...
    pos_src = 'automated_evaluation/generated_samples/positive/seed=1,positive,name=BC_VAD,samples=500,itrs=10,vad_t=0.01, lambda=2.0, pos_t=0.6, neg_t=0.4,changes=7.35,time=30659.12'
    neg_src = 'automated_evaluation/generated_samples/negative/seed=1,negative,name=BC_VAD,samples=500,itrs=10,vad_t=0.01, lambda=2.0, pos_t=0.6, neg_t=0.4,changes=8.55,time=31175.23'

    seed = 1
    step_size = 0.01
    pos_changes = 7.35
    neg_changes = 8.55
    baseline_name = 'PPLM-Dynamic-Threshold'
    ...
    length = 50
    num_iterations = 10
    inference_time_per_word = (30659.12 + 31175.23) / total_samples / length
    # obtain samples
